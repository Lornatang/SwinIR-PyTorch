...
def main() -> None:
    ...
    esrgan_model = model.__dict__[swinirnet_config.g_arch_name](in_channels=swinirnet_config.g_in_channels,
                                                                out_channels=swinirnet_config.g_out_channels,
                                                                channels=swinirnet_config.g_channels,
                                                                growth_channels=swinirnet_config.growth_channels,
                                                                num_blocks=swinirnet_config.num_blocks)
    esrgan_model = esrgan_model.to(device=swinirnet_config.device)
