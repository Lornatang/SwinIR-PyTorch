...
def build_model() -> [nn.Module, nn.Module]:
    rrdbnet_model = efficientv2_model.__dict__[rrdbnet_config.g_arch_name](in_channels=rrdbnet_config.g_in_channels,
...
def validate(
    ...
    with torch.no_grad():
        while batch_data is not None:
            ...
            if batch_index % rrdbnet_config.test_print_frequency == 0:
                progress.display(batch_index + 1)
